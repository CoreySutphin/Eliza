...
# Programming Assignment One Eliza

# This is an implementaiton of Eliza, a psycotherapist chatbot who uses word spotting to take uer's inputs
# and reformat it into questions for the user to answer.  For example, you could say "I want a hug." and Eliza
# will ask "Why do you want a hug?".

# Our implementation first formats user input into a readable form then passes it to the form_response
# function. This function uses a long list of if statements to look for certain key words and transform
# input back into a question or statement to respond to.
print "==============================================
  COREY SUTPHIN \n
  CMSC 416 Natural Language Processing \n
  Spring 2018
...
==================================================
";
print "\nHello! My name is Eliza. What is your name? \n";
...
sub form_response {
  ...
  # Failed all word spotting checks, so have the user enter different input.
  else {
